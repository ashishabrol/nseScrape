...
import arrow
expiry="31MAR2016"
wiki="http://nseindia.com/live_market/dynaContent/live_watch/get_quote/ajaxFOGetQuoteJSON.jsp?underlying=NIFTY&instrument=FUTIDX&expiry=%s&type=SELECT&strike=SELECT" % (expiry)
print wiki
...
db=sqlite3.connect("/home/nseScrape-master/test.db",isolation_level=None)
