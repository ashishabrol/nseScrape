...
for strike in strikes:
        wiki="http://nseindia.com/live_market/dynaContent/live_watch/get_quote/ajaxFOGetQuoteJSON.jsp?underlying=NIFTY&instrument=OPTIDX&expiry=%s&type=CE&strike=%s.00" % (expiry,strike)
        print wiki
